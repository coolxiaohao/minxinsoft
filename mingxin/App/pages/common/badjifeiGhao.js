...
export default class mingxin extends Component {
      ...
      <View style={styles.container}>
        <ScrollView style={{paddingVertical: 0,}}>
          <Text style={styles.nameStyles}>
            {this.state.message125}
          </Text>
          <View style={styles.formStyles}>
            <View style={styles.rowStyles}>
              <Text style={styles.textStyles}>{this.state.message126}:</Text>
              <TextInput
  ...
  getData(e){
    _that = this;
    if (e=='') {return alert(this.state.message128)} ;
    this.setState({
      loaded:true
    })

    const url= urls + "/index.php/api/index/saogongxu?&gongxuhao="+e;
      ...
      .then((json) => {
        console.log(json)
         if (json.state === 'success') {
           ...
           this.props.navigation.navigate('BadS',{dingdanhao:this.state.ReceiveCode})
